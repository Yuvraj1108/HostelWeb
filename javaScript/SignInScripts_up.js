...
{
  $('#StaffName').css("background-color","rgb(38,30,46)");
  $('#StaffName').css("color","white");
  $('#StaffName').text("Welcome ");
  $('#StaffName').append(obj.Name);
  $('#RowCSMS').hide();
  $('#RowInfo').show();
  $('#RowIOMS').hide();
  $('#RowFeedback').show();
...
function verifyUserInDatabase(obj)
{
    ...
    xhrequest.onreadystatechange=function(){
      ...
      else if(dataVerified.Status==5)  //user found in staff table
      {
         ...
         $("#StaffProfile").fadeIn();            //Should be chnaged
         $("#StudentProfile").hide();
         //$("#ChooseMeal").fadeIn();
         //$('#Dining').fadeIn();
         //$('#MessFeedback').show();
